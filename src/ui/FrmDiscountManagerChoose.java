...
public class FrmDiscountManagerChoose extends JDialog implements ActionListener{
	...
	public FrmDiscountManagerChoose(Frame f,String s,boolean b){
		super(f,s,b);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==this.okButton) {
			...
			if(this.cmbbusi.getSelectedIndex()>0) {
				...
				FrmDiscountManager fdm = new FrmDiscountManager(this, "优惠券管理界面", true, p);
				fdm.setVisible(true);
			}
		}
