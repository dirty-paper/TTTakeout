...
public class FrmFullcutManager extends JDialog implements ActionListener{
	...
	private Button btnAdd = new Button("添加满减券");
	private Button btnModify = new Button("修改满减券");
	private Button btnDelete = new Button("删除满减券");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==this.btnAdd) {
			FrmFullcutManagerAdd ffma = new FrmFullcutManagerAdd(this, "满减券增加", true);
			...
			FrmFullcutManagerMdf ffmm = new FrmFullcutManagerMdf(this,"优惠券编辑", true,bbd);
